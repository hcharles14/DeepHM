...
def main(unused_argv): 
    ...
    with tf.Session() as sess:
        ...
        cnn_outputs = tf.get_collection("cnn_outputs")[0]
        ...
        for epoch in range(num_epochs):
            ...
            for i in range(int(len_train/batch_size)): #each batch
                ...
                for j in range(1): #each num_steps
                    feed_dict={x1: data_train_x1[rand_sample,(j*num_steps*num_feature):((j+1)*num_steps*num_feature)],x2: data_train_x2_seq[:,(j*num_steps*num_feature_dna):((j+1)*num_steps*num_feature_dna)], y1: data_train_y1[rand_sample,(j*num_steps):((j+1)*num_steps)], y2: data_train_y2[rand_sample,(j*num_steps):((j+1)*num_steps)]}
            ...
            if epoch>0:
                ...
                for i in range(int(len_test/batch_size)): #each batch
                    ...
                    for j in range(1): #each num_steps
                        feed_dict={x1: data_test_x1[sample,(j*num_steps*num_feature):((j+1)*num_steps*num_feature)],x2: data_test_x2_seq[:,(j*num_steps*num_feature_dna):((j+1)*num_steps*num_feature_dna)], y1: data_test_y1[sample,(j*num_steps):((j+1)*num_steps)], y2: data_test_y2[sample,(j*num_steps):((j+1)*num_steps)]}
